	...
	this.$rules = {
		"start" : [
            ...
            {   // function declaration
                token: ["keyword", "text", "identifier", "text", "keyword.operator", "text", "entity.name.function", "text", "lparen", "identifier", "rparen"],
                regex: "(function)(\\s*)((?:\\["+variableList+"*\\])|(?:"+variableList+"*))?(\\s*)(=)(\\s*)("+variable+")(\\s*)(\\()("+variableList+"*)(\\))",
            },
            ...
            {   // complex numbers
                ...
                regex: realNumber+"\\s*[+-]\\s*"+realNumber+"i\\b"
            },
            {   // real numbers
                token: "constant.numeric",
                regex: realNumber+"\\b"
